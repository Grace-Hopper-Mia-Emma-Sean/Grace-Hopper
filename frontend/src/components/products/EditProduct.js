  ...
  return (
      <div className={classes.editproductform}>
          ...
          <div className={classes.editItem}>
              ...
              <br/>
              Edit Category: <TextField onChange={function(event) {setCategory(event.target.value), console.log(category)}}/>
          </div>
              <br/>
          <div className={classes.editItem}>
          ...
          <div className={classes.editItem}>
              ...
              <br/>
              Edit Discount: <TextField onChange={function(event) {setDiscount(event.target.value), console.log(discount)}}/>
          </div>
              <br/>
          <div className={classes.editItem}>
              Current Price: {productToEdit.price} 
              <br/>
              Edit Price: <TextField onChange={function(event) {setPrice(event.target.value), console.log(price)}}/>
          </div>
              <br/>
          <div className={classes.editItem}>
              Current Quantity: {productToEdit.quantity} 
              <br/>
              Edit Quantity: <TextField onChange={function(event) {setQuantity(event.target.value), console.log(quantity)}}/>
          </div>
              <br/>
          <div className={classes.editItem}>
              Current SKU: {productToEdit.sku}
              <br/>
              Edit SKU: <TextField onChange={function(event) {setSku(event.target.value), console.log(sku)}}/>
          </div>
              <br/>
